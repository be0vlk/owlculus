    ...
    async def test_authenticate_user_success(
        ...
        with patch('app.services.auth_service.crud.get_user_by_username') as mock_get_user:
            ...
            with patch('app.services.auth_service.security.verify_password') as mock_verify:
                ...
                with patch('app.services.auth_service.security.create_access_token') as mock_create_token:
                    mock_token = "mock_access_token"
                    mock_create_token.return_value = mock_token
                    
                    result = await auth_service_instance.authenticate_user(username, password)
                    ...
                    mock_get_user.assert_called_once_with(auth_service_instance.db, username=username)
