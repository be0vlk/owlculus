...
class TestClientService:
    ...
    async def test_get_client_with_associated_cases(self, session, test_admin, test_client):
    ...
    async def test_concurrent_client_creation_same_email(self, session, test_admin):
        ...
        client_service = ClientService(session)
        client1 = await client_service.create_client(client_data1, current_user=test_admin)
    ...
    async def test_update_client_case_insensitive_email_check(self, session, test_admin):
