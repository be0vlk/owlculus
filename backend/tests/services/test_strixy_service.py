...
class TestStrixyService:
    ...
    async def test_send_chat_message_success(self, mock_openai_class, mock_config_service_class, strixy_service):
        ...
        mock_completion.choices[0].message.content = "Hello! I'm Strixy, your OSINT assistant."
    ...
    @patch('app.services.strixy_service.SystemConfigService')
    async def test_send_chat_message_no_api_key(self, mock_config_service_class, strixy_service):
        mock_config_service = Mock()
    ...
    @patch('app.services.strixy_service.SystemConfigService')
    @patch('app.services.strixy_service.OpenAI')
    async def test_send_chat_message_openai_error(self, mock_openai_class, mock_config_service_class, strixy_service):
        mock_config_service = Mock()
        mock_config_service.get_api_key.return_value = "test-api-key"
        mock_config_service_class.return_value = mock_config_service
    ...
    @patch('app.services.strixy_service.SystemConfigService')
    @patch('app.services.strixy_service.OpenAI')
    async def test_client_reuse(self, mock_openai_class, mock_config_service_class, strixy_service):
        mock_config_service = Mock()
        mock_config_service.get_api_key.return_value = "test-api-key"
        mock_config_service_class.return_value = mock_config_service
