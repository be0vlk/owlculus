...
class WebSocketManager:
    ...
    async def send_progress_update(self, execution_id: int, progress: float, step_id: str = None):
    ...
    async def send_step_complete(self, execution_id: int, step_id: str, progress: float):
