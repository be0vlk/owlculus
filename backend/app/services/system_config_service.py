...
class SystemConfigService:
    ...
    async def update_configuration(
        ...
        if case_number_template == "PREFIX-YYMM-NN":
            ...
            if not case_number_prefix.isalnum() or len(case_number_prefix) < 2 or len(case_number_prefix) > 8:
    ...
    def generate_example_case_number(self, template: str, prefix: Optional[str] = None) -> str:
