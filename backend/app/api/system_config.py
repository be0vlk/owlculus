...
@router.get("/configuration", response_model=system_config_schema.SystemConfigurationResponse)
@admin_only()
...
@router.put("/configuration", response_model=system_config_schema.SystemConfigurationResponse)
@admin_only()
...
@router.get("/configuration/preview", response_model=system_config_schema.SystemConfigurationPreview)
@admin_only()
