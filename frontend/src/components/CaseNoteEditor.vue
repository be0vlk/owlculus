<template>
  <div>
    <!-- Normal Card View -->
    <div v-if="!expanded" class="note-editor-container">
      <EditorToolbar
      ...
      <div class="pa-4" :class="{ 'read-only-notes': !isEditing }" style="min-height: 200px;">
          ...
          <v-container fluid class="flex-grow-1 overflow-auto pa-6">
            <v-row justify="center">
              <v-col cols="12" lg="10" xl="8">
                <div :class="{ 'read-only-notes': !isEditing }">
...
import { useCaseNoteManualSave } from '../composables/useCaseNoteManualSave'
...
const {
  ...
  formatLastSaved,
  updateContent,
} = useCaseNoteManualSave(props, emit)
